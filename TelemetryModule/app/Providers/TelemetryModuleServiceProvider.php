...
class TelemetryModuleServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'TelemetryModule';

    protected string $moduleNameLower = 'telemetrymodule';
