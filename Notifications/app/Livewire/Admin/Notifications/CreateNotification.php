...
class CreateNotification extends Component implements HasForms
{
    ...
    public function createNotification()
    {
        ...
        \Filament\Notifications\Notification::make()
            ->success()
            ->title(__('notifications::notifications.create_notification.notifications.notification_created'))
            ->send();
    ...
    {
        return view('notifications::livewire.admin.notifications.create-notification')
            ->layout('components.layouts.admin', ['title' => __('notifications::notifications.create_notification.tab_title')]);
    }
}
