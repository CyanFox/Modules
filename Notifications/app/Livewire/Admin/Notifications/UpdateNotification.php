...
class UpdateNotification extends Component implements HasForms
{
        ...
        return $form
            ->schema([
                MarkdownEditor::make('messageContent')
                    ->name(__('notifications::notifications.message'))
    ...
    public function updateNotification()
    {
        ...
        \Filament\Notifications\Notification::make()
            ->success()
            ->title(__('notifications::notifications.update_notification.notifications.notification_updated'))
            ->send();
    ...
    {
        return view('notifications::livewire.admin.notifications.update-notification')
            ->layout('components.layouts.admin', ['title' => __('notifications::notifications.update_notification.tab_title',
