...
namespace Modules\NotificationModule\app\Livewire\Components;

use Livewire\Attributes\On;
use Livewire\Component;
use Modules\NotificationModule\app\Models\DismissedNotification;
...
class Notifications extends Component
{
    ...
    public function getNotifications()
    {
        ...
        foreach ($notifications as $notification) {
            ...
            $notification->files = collect($filePaths)->map(function ($path) {
    ...
    {
        return view('notificationmodule::livewire.components.notifications');
    }
}
