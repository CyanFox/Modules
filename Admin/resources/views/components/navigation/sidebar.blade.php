    ...
    <div class="h-svh w-full overflow-y-auto bg-white dark:bg-neutral-950 transition-all duration-300 ease-in-out"
        ...
        <nav
            ...
            <div class="relative flex items-center ml-auto">
                <div class="mr-2">
                    <i class="icon-search cursor-pointer text-neutral-900 dark:text-white"
                       @click="$dispatch('open-spotlight')"></i>
                </div>
                <div class="ml-2">
                    <x-dropdown>
                        <x-dropdown.trigger>
                        ...
                        <x-dropdown.items>
                            <x-admin::profile-item icon="icon-user" :label="__('admin::navigation.profile')"
                                                   route="account.profile" external/>

                            <x-admin::profile-item icon="icon-house" :label="__('admin::navigation.home')"
                            ...
                            <x-admin::profile-item icon="icon-log-out" :label="__('admin::navigation.logout')"
                                                   route="auth.logout" external/>
                        </x-dropdown.items>
                    </x-dropdown>
                </div>
            </div>
