...
final class UsersTable extends PowerGridComponent
{
    ...
    public function actions(User $row): array
    {
        return [
            Button::add('update')
                ->slot(Blade::render('<x-button.floating size="sm" wire:navigate link="'.route('admin.users.update', ['userId' => $row->id]).'"><i class="icon-pen"></i></x-button.floating>')),

            Button::add('delete')
                ->slot(Blade::render('<x-button.floating color="danger" size="sm" wire:click="deleteUser(`'.$row->id.'`, false)"><i class="icon-trash"></i></x-button.floating>')),
        ];
    }
